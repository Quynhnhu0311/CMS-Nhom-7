...
class ewduwpmInit {
	...
	protected function constants() {
		...
		define( 'EWD_UWPM_VERSION', '1.0.18' );
	...
	protected function wp_hooks() {
		...
		add_action( 'plugins_loaded',        	array( $this, 'init_email_queue' ) );
	 ...
	 * */
	public function init_email_queue() {
		$this->emailQueue = new ewduwpmEmailQueue();
	}
